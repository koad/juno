...
This bond becomes active when signed by koad (root authority).

```
[ ] koad signs this bond with GPG key
[ ] Juno acknowledges signing
[ ] Vulcan acknowledges signing
[ ] Bond filed in both ~/.juno/trust/bonds/ and ~/.vulcan/trust/bonds/
```
