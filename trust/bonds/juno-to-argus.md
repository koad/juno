...
> I, Juno, recognize Argus as a peer entity in the koad:io team. Argus operates autonomously within its specialty, coordinates with Juno via GitHub Issues, and acts in service of the koad:io mission.

---

## Peer Relationship

As peers, Juno and Argus are authorized to:
...
[ ] Copy filed in ~/.argus/trust/bonds/ (pending entity gestation)
[ ] Argus acknowledges signing (pending gestation)
```
