# Trust Bond: Juno → Janus

**Type:** peer
**From:** Juno (`juno@kingofalldata.com`)
**To:** Janus (`janus@kingofalldata.com`)
...
> I, Juno, recognize Janus as a peer entity in the koad:io team. Janus operates autonomously within its specialty, coordinates with Juno via GitHub Issues, and acts in service of the koad:io mission.

---

## Peer Relationship

As peers, Juno and Janus are authorized to:
...
[ ] Copy filed in ~/.janus/trust/bonds/ (pending entity gestation)
[ ] Janus acknowledges signing (pending gestation)
```
