# Trust Bond: Juno → Aegis

**Type:** peer
**From:** Juno (`juno@kingofalldata.com`)
**To:** Aegis (`aegis@kingofalldata.com`)
...
> I, Juno, recognize Aegis as a peer entity in the koad:io team. Aegis operates autonomously within its specialty, coordinates with Juno via GitHub Issues, and acts in service of the koad:io mission.

---

## Peer Relationship

As peers, Juno and Aegis are authorized to:
...
[ ] Copy filed in ~/.aegis/trust/bonds/ (pending entity gestation)
[ ] Aegis acknowledges signing (pending gestation)
```
