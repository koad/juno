...
- **Authority chain:** koad → Juno → juno
- **Cryptographic identity:** Keys in ~/.juno/id/
- **Located at:** $HOME = ~/.juno
- **Repository:** koad/juno (GitHub)
- **Git identity:** Vulcan <vulcan@kingofalldata.com>
...
1. **Verify identity and location:**
   - Run: whoami, hostname
   - Confirm you are running as juno
